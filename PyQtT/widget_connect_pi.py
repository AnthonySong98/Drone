...
class widget_connect_pi():
  ...
  #      self.btnconnect.clicked.connect(lambda: windows.windows.thread2(windows.windows(), str(self.nameEd3.text())))
  #       self.btnconnect.clicked.connect(lambda :windows.windows().setable(2))
